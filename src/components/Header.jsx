...
const Header = () => {
  ...
  return (
    <>
      <nav className="navbar fixed top-0 right-0 left-0 z-50 shadow bg-white">
        <div className="container mx-auto px-4 flex justify-evenly items-center h-16">
          {/* Start: Logo / Brand */}
          <div className="navbar-start">
            <a href="/" id="main-heading" className="text-xl font-bold">
              Harry Potter Fandom
            </a>
          </div>
          ...
          {/* Center and End: Hidden on mobile, flex on medium+ screens */}
          <div className="hidden md:flex items-center space-x-4">
            {/* Placeholder center button if needed */}
            {/* <a href="#" className="btn btn-ghost border p-1 rounded-lg">Choose the house</a> */}
            <a
            ...
            >
              ...
              <div class="flex items-center">
                ...
                <span class="mx-1 text-white">See on GitHub</span>
              </div>
            </a>
          </div>
        </div>
      ...
      <div className="hogwarts pt-20 bg-fixed h-[100%] pb-10">
        <Outlet />
      </div>
    </>
  );
